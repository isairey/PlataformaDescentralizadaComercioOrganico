...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCYM3UHM65NEIE45GXPC6PVIGYHOUYKB3EMNVX5GNTS6OXFUQOJF7DF2";
    };
};
export type DataKey = {
    tag: "Order";
...
export declare class Contract {
    ...
    token: <R extends "simulated" | "full" | undefined = undefined>(options?: {
        /**
    ...
    recipient: <R extends "simulated" | "full" | undefined = undefined>(options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number | undefined;
    ...
    transferXlm: <R extends "simulated" | "full" | undefined = undefined>({ from, to, amount }: {
        from: string;
        to: string;
        amount: i128;
    }, options?: {
    ...
    register: <R extends "simulated" | "full" | undefined = undefined>({ user_address, name, email }: {
        user_address: string;
        name: string;
        email: string;
    }, options?: {
    ...
    login: <R extends "simulated" | "full" | undefined = undefined>({ user_address }: {
        user_address: string;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    getUserName: <R extends "simulated" | "full" | undefined = undefined>({ user_address }: {
        user_address: string;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    initialize: <R extends "simulated" | "full" | undefined = undefined>({ recipient, target_amount, token }: {
        recipient: string;
        target_amount: i128;
        token: string;
    }, options?: {
    ...
    placeOrder: <R extends "simulated" | "full" | undefined = undefined>({ user, amount }: {
        user: string;
        amount: i128;
    }, options?: {
        /**
    ...
    getOrder: <R extends "simulated" | "full" | undefined = undefined>({ order_id }: {
        order_id: u64;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
         ...
         */
        secondsToWait?: number | undefined;
    }) => Promise<R extends undefined ? Order : R extends "simulated" ? SorobanClient.SorobanRpc.SimulateTransactionResponse : R extends "full" ? SorobanClient.SorobanRpc.SimulateTransactionResponse | SorobanClient.SorobanRpc.SendTransactionResponse | SorobanClient.SorobanRpc.GetTransactionResponse : Order>;
    getTotalUserRewards: <R extends "simulated" | "full" | undefined = undefined>({ user }: {
        user: string;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    processUserReward: <R extends "simulated" | "full" | undefined = undefined>({ user }: {
        user: string;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    getOrdersByUser: <R extends "simulated" | "full" | undefined = undefined>({ user, start, limit }: {
        user: string;
        start: u64;
        limit: u64;
    }, options?: {
